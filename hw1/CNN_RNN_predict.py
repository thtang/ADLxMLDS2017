...
for b in test_batch:
    ...
    for index, instance_id in enumerate(b):
        ...
        if index ==0:
            ...
            temporal_feature.append(np.hstack((mfcc_test_dict[b[index-1]] , fbank_test_dict[b[index-1]])))
            
        temporal_feature.append(np.hstack((mfcc_test_dict[b[index]] , fbank_test_dict[b[index]])))
